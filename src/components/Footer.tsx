    ...
    <footer className="relative bg-stone-950 text-stone-300 pt-12 pb-10 border-t border-stone-800">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10 rounded-3xl bg-emerald-950/50 border border-emerald-800/60 p-5 sm:p-7 flex flex-col md:flex-row items-center justify-between gap-5">
          <div className="space-y-1 text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-2">
              ...
              <span className="text-xs font-bold tracking-wider text-emerald-300 uppercase">
                Strictly Email Patient Inquiries
              </span>
            </div>
            ...
            <p className="text-xs text-stone-400">
              Our Australian clinical team reviews your symptoms and confirms scheduling by email within 4 hours.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-2.5">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full bg-emerald-700 hover:bg-emerald-600 px-5 py-2.5 text-xs font-semibold text-white transition-colors shadow-xs"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pb-10 border-b border-stone-800">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-[#244836] text-lime-300">
                <span className="h-2.5 w-2.5 rounded-full bg-lime-300 animate-pulse" />
              </div>
            ...
            {/* Social Media Placeholders (strictly without links per user request) */}
            <div className="pt-3 space-y-1.5">
              <div className="text-[11px] font-bold uppercase tracking-wider text-stone-400">
                Official Channels (Placeholders)
              </div>
              
              {socialNote && (
                <div className="text-[10px] text-lime-300 bg-emerald-950/80 px-2 py-1 rounded-lg border border-emerald-800">
                  {socialNote}
                </div>
              )}
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-stone-500">
          <p>© {new Date().getFullYear()} Dantora Health Australia. All rights reserved. Strictly email contact.</p>
          <p>Care designed for your comfort, privacy, and peace of mind.</p>
        </div>
